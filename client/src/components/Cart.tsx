    ...
    return (
        <section>
            <div className={` flex items-center space-x-4 pr-2 ${role === "worker" ? "bg-blue-100" : "bg-green-100"} rounded-xl`}>
                <Link to={'/detailes'}>
                    <img className=" h-[130px] w-[110px] object-cover" src="https://t4.ftcdn.net/jpg/01/85/03/97/360_F_185039759_C6rijMdG2F8NoBRYA8NiUjlHMKU6vjKy.jpg" alt="clean-service-image" />
                </Link>
                <div>
                    <Link to={'/detailes'}>
                        <h3 className=" font-semibold text-lg"> House cleaner</h3>
                        <div className=" opacity-70">J.m Askar</div>
                        <div className=" text-sm opacity-70">Trincomalee naduoothu kinniya</div>
                    </Link>
                    <div className=" flex space-x-2 pt-2">
                        <button className=" bg-green-500 hover:bg-green-600 cursor-pointer transition-all  text-white flex items-center space-x-2 p-1.5 rounded">
                        ...
                        <button className=" bg-blue-500 hover:bg-blue-600 transition-all cursor-pointer  text-white flex items-center space-x-2 p-1.5 rounded">
                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><path fill="currentColor" d="M19.95 21q-3.125 0-6.175-1.362t-5.55-3.863t-3.862-5.55T3 4.05q0-.45.3-.75t.75-.3H8.1q.35 0 .625.238t.325.562l.65 3.5q.05.4-.025.675T9.4 8.45L6.975 10.9q.5.925 1.187 1.787t1.513 1.663q.775.775 1.625 1.438T13.1 17l2.35-2.35q.225-.225.588-.337t.712-.063l3.45.7q.35.1.575.363T21 15.9v4.05q0 .45-.3.75t-.75.3"></path></svg>
                            <span>Mobile</span>
                        </button>
                    </div>
                </div>
